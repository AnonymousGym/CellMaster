...
class LiverExperimentAgent(BaseExperimentAgent):
    def propose_experiment(self,annotation_dict = None,no_gene_cluster=None,failed_genes=None,successful_genes=None,subset=False,model_name = "gpt-4o",model_provider = "openai",API_key = None):
        if no_gene_cluster:
            prompt = f'''
    ...
    '''
            ...
            LLM_output = query_llm(content=prompt,system_role=system_role,model_provider=model_provider,model_name=model_name,API_key = API_key)
