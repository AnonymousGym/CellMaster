...
class LiverEvaluationAgent(BaseEvaluationAgent):
    def __init__(self, hypothesis, output_dir, input_dir, existing_genes, file_name,model_name = "gpt-4o",model_provider = "openai",API_key = None):
    ...
    def evaluate(self, groupby, dotplot=None,duplet_rule="", contamination_rule="",possible_cell_types = "",iteration=1):
        ...
        LLM_output = query_llm(content=content,system_role=system_role,model_provider=self.model_provider,model_name=self.model_name,API_key = self.API_key)
